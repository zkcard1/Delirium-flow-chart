...
flowchart TD
    ...
    C --> D{Delirium Screen Positive? CAM or 4AT >=4}
    D -- No --> C
    ...
    L --> L2[Pharmacological: treat underlying cause, symptom management]
